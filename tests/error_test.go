...
func TestErrors(t *testing.T) {
	...
	AssertEqual(t, const1, yices2.NULL_TERM)
	AssertEqual(t, error_string, "invalid type in constant creation")
	yices2.Clear_error()
	AssertEqual(t, yices2.Error_code(), 0)
	errstr = yices2.Error_string()
	AssertEqual(t, errstr, "no error")
	yices2.Print_error(os.Stderr)
	yices2.Clear_error()
